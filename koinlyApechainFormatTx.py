...
koinly_format['Date'] = pd.to_datetime(df['DateTime (UTC)']).dt.strftime('%Y-%m-%d %H:%M UTC')
...
koinly_format['Fee Amount'] = df['TxnFee(APE)']
koinly_format['Fee Currency'] = 'APE'
...
koinly_format['TxHash'] = df['Txhash']
